...
<div class="GreenTitleWidth">
	<h1><dnn:TITLE runat="server" id="dnnTITLE" CssClass="ContainerTitle" /></h1>
	<div class="GreenTitleVisibilitycell"><dnn:VISIBILITY runat="server" id="dnnVISIBILITY" /></div>
	<div class="ClearFloat"></div>
	<div class="GreenTitleContentpane" id="ContentPane" runat="server"></div>
 </div>
